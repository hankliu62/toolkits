...
const Demo = {
  ...
  labels_url: 'https://api.github.com/repos/hankliu62/hankliu62.github.com/issues/80/labels{/name}',
  comments_url: 'https://api.github.com/repos/hankliu62/hankliu62.github.com/issues/80/comments',
  events_url: 'https://api.github.com/repos/hankliu62/hankliu62.github.com/issues/80/events',
  ...
  user: {
    ...
    following_url: 'https://api.github.com/users/hankliu62/following{/other_user}',
    gists_url: 'https://api.github.com/users/hankliu62/gists{/gist_id}',
    starred_url: 'https://api.github.com/users/hankliu62/starred{/owner}{/repo}',
    ...
    received_events_url: 'https://api.github.com/users/hankliu62/received_events',
    type: 'User',
    site_admin: false,
  },
  labels: [
  ...
  timeline_url: 'https://api.github.com/repos/hankliu62/hankliu62.github.com/issues/80/timeline',
  ...
  return (
    <div className="relative flex min-h-[100vh] flex-1 flex-col bg-white">
      ...
      <SplitPane className="flex-1" split="vertical" minSize={50} maxSize={75}>
        ...
        <div className="overflow-y-auto">
          <div className="flex justify-between border-b border-black/20 px-6 py-4">
            <h2 className="text-lg font-medium leading-[32px]">Typescript类型</h2>
