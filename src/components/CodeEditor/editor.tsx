 ...
 * @returns
 */
const SqlEditor: ForwardRefRenderFunction<ICodeEditorMethods, ICodeEditorProps> = (
  {
    width = '100%',
    height = '100%',
    value = '',
    ...
    options = {},
    onChange = () => {},
    onMount = (_editor: monaco.editor.IStandaloneCodeEditor, _monaco: Monaco) => {},
  }: ICodeEditorProps,
  ref,
) => {
  ...
  useEffect(() => {
    function handleThemeChange(theme) {
      monaco.editor.setTheme(options?.theme || theme === 'light' ? 'vs-dark' : 'vs-light');
    }
